...
os.system('pyinstaller --noconfirm --onefile --console --specpath '+spec_path+' --distpath '+dist_path+' --icon "'+project_path+'etc/img/SecurityCamera_icon-icons.com_55219.ico" --name '+app_name+'  --paths "'+source_path+'"  "'+source_path+main_script_name+'"')
